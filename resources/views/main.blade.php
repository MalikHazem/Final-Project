                                    ...
                                    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                                        ...
                                        <div class="col mb-5">
                                            <div class="card h-100">
                                                <a href="{{url('api/Paintings/show_painting',$painting->id)}}"><img class="card-img-top" src="{{url('images',$painting->image)}}" width="450px" height="150px"></a>
